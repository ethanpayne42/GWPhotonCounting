...
for id in range(int(1.1e4)):
    ...
    dag_lines += ['\n',
        f"JOB {id} /home/ethan.payne/projects/GWPhotonCounting/projects/PM_EOS/hierarchical_EOS/injection_noise_submit.sub",
        f"VARS {id} "\
        f"id=\"{id}\" "]
...
# Write out to file
with open(f'injection_noise_submission.dag', 'w+') as filehandle:
